...
import { Settings2, ChevronUp, Sliders, Wand2, Clapperboard } from 'lucide-react'
...
interface VisualizerControlsSidebarProps {
  ControlsComponent: SidebarSurface
}

const FxPanel = lazy(() =>
  import('./FxPanel').then((module) => ({
    default: module.FxPanel,
  })),
)
...
export function VisualizerControlsSidebar({
  ControlsComponent,
}: VisualizerControlsSidebarProps) {
  const [isOpen, setIsOpen] = useState(false)
  const [activeTab, setActiveTab] = useState<'visuals' | 'fx' | 'export'>('visuals')
